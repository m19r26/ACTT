...
if("TRUE" STREQUAL "TRUE")
  set(mpu6050_SOURCE_PREFIX /home/pi/catkin_auto/src/ros-mpu6050-node)
  set(mpu6050_DEVEL_PREFIX /home/pi/catkin_auto/devel)
  set(mpu6050_INSTALL_PREFIX "")
  set(mpu6050_PREFIX ${mpu6050_DEVEL_PREFIX})
else()
  set(mpu6050_SOURCE_PREFIX "")
  set(mpu6050_DEVEL_PREFIX "")
  set(mpu6050_INSTALL_PREFIX /home/pi/catkin_auto/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "https://github.com/matpalm/ros-mpu6050-node " STREQUAL " ")
    set(_report "Check the website 'https://github.com/matpalm/ros-mpu6050-node' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'mat <matthew.kelcey+github@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu6050' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_auto/src/ros-mpu6050-node/${idir}'.  ${_report}")
    endif()
