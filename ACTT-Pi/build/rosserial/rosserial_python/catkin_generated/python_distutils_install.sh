...
echo_and_run cd "/home/pi/catkin_auto/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/pi/catkin_auto/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/pi/catkin_auto/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
