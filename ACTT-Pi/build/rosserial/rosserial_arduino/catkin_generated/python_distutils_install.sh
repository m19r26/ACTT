...
echo_and_run cd "/home/pi/catkin_auto/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/pi/catkin_auto/src/rosserial/rosserial_arduino/setup.py" \
    build --build-base "/home/pi/catkin_auto/build/rosserial/rosserial_arduino" \
    install \
    $DESTDIR_ARG \
