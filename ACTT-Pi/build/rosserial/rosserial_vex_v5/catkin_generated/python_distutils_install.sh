...
echo_and_run cd "/home/pi/catkin_auto/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/pi/catkin_auto/src/rosserial/rosserial_vex_v5/setup.py" \
    build --build-base "/home/pi/catkin_auto/build/rosserial/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
