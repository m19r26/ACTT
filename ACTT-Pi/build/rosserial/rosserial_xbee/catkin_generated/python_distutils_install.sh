...
echo_and_run cd "/home/pi/catkin_auto/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/pi/catkin_auto/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/pi/catkin_auto/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
